    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          <h2>5. 位置情報の利用</h2>
          <p>
            当サイトの「近い順」表示など一部の機能では、ご利用の端末（ブラウザ）の位置情報を
            利用することがあります。位置情報の取得には必ずブラウザ上での許可が必要で、
            許可しない場合でも、その他の機能は通常どおりご利用いただけます。
          </p>
          <p>
            取得した位置情報は、お近くの団体を表示するための距離計算に端末内でのみ使用し、
            当サイトのサーバーや第三者に送信・保存することはありません。
          </p>
        </section>
