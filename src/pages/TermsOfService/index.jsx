      ...
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            当サイトに掲載されている情報は、各団体から各自治体に提供された情報に基づいていますが、その正確性、
        ...
        <section className={styles.section}>
          <h2>5. データの再利用について</h2>
          <p>
            当サイトが掲載する団体情報・お出かけスポット情報等のデータは、出典を明示していただく場合に限り、
            営利を目的としない範囲での再利用（複製、加工、転載等を含みます）を認めます。
          </p>
          <p>
            商用目的（当サイトのデータを用いた製品・サービスの提供、広告収益を伴う二次利用等を含みますが、
            これらに限りません）での利用は禁止します。商用利用をご希望の場合は、事前に「10. お問い合わせ」記載の
            連絡先までご相談ください。
          </p>
          <p>
            なお、当サイトが第三者の提供するデータ（OpenStreetMapのデータ等）を利用している場合、
            当該データについては提供元が定めるライセンス（例: ODbL）が別途適用されます。
          </p>
        </section>
